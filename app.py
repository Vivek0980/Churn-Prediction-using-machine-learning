...
model = pickle.load(open('C:/Users/Admin/Downloads/7_logistic_model.pkl','rb'))
...
if st.button("Predict churn or not"):
    ...
    if result == 1:
        ...
        #cd "C:/Users/Admin/OneDrive/Pictures/Feedback/{56D9003E-2618-433F-96D8-7523A52977E2}/"